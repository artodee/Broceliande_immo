...
<head>
    ...
    <title>Agence immobilière de Quimer</title>
        <!-- Bootstrap -->
        ...
        <div class="container">
            <div class="row">
                <section class="photo-section col-md-6">
                    <img src="Images/agence_quimper.jpeg" alt="Photo de l'agence immobilière de Quimper">
                </section>
                <section class="description-section col-md-6">
                    <h2>Présentation de l'agence</h2>
                    <p>L'agence de Quimper situé dans le centre ville</p>
