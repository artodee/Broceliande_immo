...
<section class="apartment-details">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images/annonce3.1.jpg" class="d-block w-100" alt="Image 1">
    </div>
    <div class="carousel-item">
      <img src="Images/annonce3.2.jpg" class="d-block w-100" alt="Image 2">
    </div>
    <div class="carousel-item">
      <img src="Images/annonce3.jpg" class="d-block w-100" alt="Image 2">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="col-md-6">
        ...
        <p>Vous cherchez un espace élégant et contemporain pour appeler chez vous ? Ne cherchez plus ! Notre appartement moderne est l’endroit idéal pour les personnes qui apprécient le confort, le style et la fonctionnalité.</p>
        <ul>
          <li>Chambre(s): 2</li>
          <li>Salle(s) de bain: 1</li>
          <li>Superficie: 200m²</li>
          <li>Prix: 300€ par mois "charges non incluses"</li>
        </ul>
