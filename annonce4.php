...
<head>
    ...
    <title>Annonce3 - Brocéliande Immo</title>
    <!-- Bootstrap -->
...
<section class="apartment-details">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images/annonce4.1.jpg" class="d-block w-100" alt="Image 1">
    </div>
    <div class="carousel-item">
      <img src="Images/annonce4.2.jpg" class="d-block w-100" alt="Image 2">
    </div>
    <div class="carousel-item">
      <img src="Images/annonce4.jpg" class="d-block w-100" alt="Image 2">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <div class="col-md-6">
        <h2>Maison Spacieuse</h2>
        <p>Vous cherchez un espace élégant, confortable et idéalement situé ? Ne cherchez plus ! Notre maison spacieuse est parfaite pour les amateurs d’espace, de lumière et de tranquillité.</p>
        <ul>
          <li>Chambre(s): 5</li>
          <li>Salle(s) de bain: 3</li>
          <li>Superficie: 500m²</li>
          <li>Prix: 2500€ par mois "charges non incluses"</li>
        </ul>
